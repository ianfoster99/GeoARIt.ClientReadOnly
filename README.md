...
The code contains an api key to access data on the [Demo](https://geoar.it/Venue/Index) account at [https://GeoAr.it](https://geoar.it).[Read more about setup](https://geoar.it/api-docs/index.html).
